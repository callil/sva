    ...
    return (
      <div className="">
        ...
        <div className={this.state.scatter ? 'info' : 'info behind'} onMouseLeave={this.wiggle} onMouseEnter={this.wiggle}>
          ...
          <p>We are already superhuman. This course teaches you the skills to use digital & interaction design to intelligently and critically design for our cyborg reality. Technology is augmenting you nearly every moment of your life - interaction design is the field that gives you the tools to define how that augmentation will happen. We’ll answer questions you’ve always been asking such as: </p>
          <ul>
